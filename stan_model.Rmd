...
fit <- stan(file = "models/model5-quadratic-exposure.stan",
            data = stan_data,
            model_name = "quadratic",
            iter = 4000, warmup = 1000, chains = 4, seed = 123)
saveRDS(fit, file="models/model5_fit.rds")
```
...
fit <- stan(file = "models/model6-cubic-exposure.stan",
            data = stan_data,
            model_name = "cubic",
            iter = 4000, warmup = 1000, chains = 4, seed = 123)
saveRDS(fit, file="models/model6_fit.rds")
```
...
# Compare them
compare_models(loo_linear, loo_quad, loo_cubic)
```
